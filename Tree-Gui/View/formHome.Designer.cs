namespace Tree_Gui.View {
    partial class formHome {
        ...
        private void InitializeComponent() {
            ...
            customRectangle1.Controls.Add(lblStreakTitle);
            customRectangle1.CornerRadius = 20;
            customRectangle1.Location = new Point(136, 933);
            customRectangle1.Margin = new Padding(20);
            customRectangle1.Name = "customRectangle1";
            customRectangle1.Size = new Size(682, 415);
            customRectangle1.TabIndex = 3;
            customRectangle1.Text = "customRectangle1";
            // 
            // lblStreakTitle
            // 
            lblStreakTitle.AutoEllipsis = true;
            lblStreakTitle.AutoSize = true;
            lblStreakTitle.Font = new Font("Bahnschrift", 18F, FontStyle.Regular, GraphicsUnit.Point);
            lblStreakTitle.ForeColor = Color.White;
            lblStreakTitle.Location = new Point(269, 36);
            lblStreakTitle.Margin = new Padding(25);
            lblStreakTitle.Name = "lblStreakTitle";
            lblStreakTitle.Size = new Size(105, 43);
            lblStreakTitle.TabIndex = 2;
            lblStreakTitle.Text = "Level";
            // 
            // formHome
            // 
